...
const stats = [
  ...
  { icon: "lightbulb", number: 10000, label: "Startups" },
  { icon: "student", number: 100000, label: "Students" },
];
  ...
  return (
    <>
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div className="relative w-full h-auto py-12 md:py-16 overflow-hidden bg-[#243137] rounded-2xl">
          {/* Overlay */}
          <div className="absolute inset-0 bg-[#243137] "></div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-around px-4 md:px-8 text-white z-10">
            {stats.map((stat, index) => (
              <div key={index} className="flex flex-col items-center justify-center p-4">
                ...
                {/* Animated Number using CountUp */}
                <div className="text-4xl md:text-5xl font-bold text-yellow-500 mb-1">
