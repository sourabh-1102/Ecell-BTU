            ...
            <div className="bg-gray-900 py-6 sm:py-8 lg:py-12">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
                        ...
                        <a
                            href="#"
                            className="inline-block rounded-lg border border-gray-700 bg-gray-800 px-4 py-2 text-center text-sm font-semibold text-gray-300 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:px-8 md:py-3 md:text-base"
                        >
                            More
                        </a>
                    </div>
