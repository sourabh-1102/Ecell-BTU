    ...
    <>
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          {/* 'More' button - Updated to Link component */}
          <div className="flex justify-end mt-3">
            <Link
              to="/moregallery"  // This will route to the MoreGallery page
              className="inline-block rounded-lg border border-gray-700 bg-[#243137] px-4 py-2 text-center text-sm font-semibold text-white outline-none transition duration-100 hover:bg-black hover:scale-105 hover:shadow-md hover:shadow-black transition-duration-300"
            >
              More
            </Link>
          </div>
