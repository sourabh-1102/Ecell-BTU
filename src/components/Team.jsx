                ...
                <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:gap-y-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
                        ...
                        <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
                            <div className="h-24 w-24 overflow-hidden rounded-full bg-gray-800 shadow-lg md:h-32 md:w-32">
                                <img
                            ...
                            <div>
                                <div className="text-center font-bold text-indigo-400 sm:text-left md:text-lg">
                                    John McCulling
                                </div>
                                <p className="text-center text-sm text-gray-400 sm:text-left md:text-base">
                                    Founder / CEO
                                </p>
                            </div>
                        </div>
